    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="token-box">
                ...
                <div class="token-code" id="tokenCode">{{ $token }}</div>
            ...
            <div style="text-align: center;">
                ...
                <a href="{{ url('/reset-password?token=' . $token . '&email=' . urlencode($email)) }}" class="btn-primary">
        ...
        <div class="footer">
            <p>© {{ date('Y') }} تطبيقك. جميع الحقوق محفوظة.</p>
        </div>
    </div>
